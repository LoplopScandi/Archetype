...
//File: index_ov2640.html.gz, Size: 6895
//変更するときは、webserverにつなげhtmlをダウンロードする
//エディタで編集
//https://gchq.github.io/CyberChef/#recipe=Gzip('Dynamic%20Huffman%20Coding','ESP32_OV2460.html.gz','',false)To_Hex('0x',0)Split('0x',',0x')　にアクセス
//htmlを上に張り付ける、下の16進数をコピペして対応するhtmlの変数に代入させる。
//変換器の右下に変換後のlengthがあるのでそれをコピー
//#define　のlenに張り付ける
#define index_ov2640_html_gz_len 6895
