...
const char *ssid_Router     = "inoken";  //input your wifi name
const char *password_Router = "88888888";  //input your wifi passwords
...
void camera_init() {
  ...
  config.frame_size = FRAMESIZE_QVGA; //フレームサイズ
  config.pixel_format = PIXFORMAT_JPEG; // for streaming
  //config.pixel_format = PIXFORMAT_RGB565; // for face detection/recognition
  config.grab_mode = CAMERA_GRAB_WHEN_EMPTY;
  config.fb_location = CAMERA_FB_IN_DRAM; //PSRAMではなくDRAMを使う
